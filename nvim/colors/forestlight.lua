...
hi(0, "@function",              { fg = c.fg0 })
hi(0, "@function.builtin",      { fg = c.g4 })
hi(0, "@function.call",         { fg = c.g4 })
hi(0, "@function.macro",        { fg = c.t3 })
hi(0, "@method",                { fg = c.fg0 })
hi(0, "@method.call",           { fg = c.g4 })
hi(0, "@constructor",           { fg = c.t2 })
hi(0, "@parameter",             { fg = c.t5 })
hi(0, "@keyword",               { link = "Keyword" })
hi(0, "@keyword.function",      { fg = c.g2,   bold = true })
hi(0, "@keyword.operator",      { fg = c.fg3 })
...
hi(0, "@type.qualifier",        { fg = c.g2,   bold = true })
hi(0, "@namespace",             { fg = c.t1 })
hi(0, "@include",               { link = "Include" })
hi(0, "@variable",              { fg = c.fg0 })
hi(0, "@variable.builtin",      { fg = c.g2,   italic = true })
hi(0, "@constant",              { fg = c.t5 })
hi(0, "@constant.builtin",      { fg = c.red,  bold = true })
hi(0, "@field",                 { fg = c.fg0 })
hi(0, "@property",              { fg = c.fg0 })
hi(0, "@punctuation.bracket",   { fg = c.fg3 })
hi(0, "@punctuation.delimiter", { fg = c.fg3 })
